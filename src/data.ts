...
export const blocks: Block[] = [
  ...
  { id: 'J', title: 'SAFETY + OBSERVABILIDAD', description: 'Control de riesgo en profundidad', phase: 'Fases 3.4-3.5 (cerradas)' },
  { id: 'K-L', title: 'EMS TÁCTICO', description: 'Ejecución avanzada y calidad de fill', phase: 'Fases 3.6-3.9 (cerradas)' },
  { id: 'M', title: 'MANDO Y CONTROL', description: 'Alertas, comando y cockpit', phase: 'Fases 4.0-4.2 (siguiente)' },
...
export const features: Feature[] = [
  ...
  { id: 62, block: 'J', name: 'Kill switch FSM de 6 estados', description: 'Protocolo de emergencia verificable.', longDescription: 'Pasa de pausa a cierre con estados trazables y confirmación operativa.', status: 'CONSTRUIDO', icon: 'Power' },
  { id: 63, block: 'J', name: 'WriteBarrier global', description: 'Control central de escritura a mercado.', longDescription: 'Bloquea aperturas cuando el sistema no es seguro y preserva el carril de cierre.', status: 'CONSTRUIDO', icon: 'Shield' },
  { id: 64, block: 'J', name: 'Safe-to-trade continuo', description: 'Semáforo operativo en tiempo real.', longDescription: 'Evalúa salud integral antes de habilitar nueva exposición.', status: 'CONSTRUIDO', icon: 'Activity' },
  { id: 65, block: 'J', name: 'Anti-bypass de ejecución', description: 'Una sola puerta de entrada a mercado.', longDescription: 'Refuerza gobernanza para evitar rutas paralelas no autorizadas.', status: 'CONSTRUIDO', icon: 'Lock' },
  { id: 66, block: 'J', name: 'Idempotencia contractual', description: 'Evita duplicados en condiciones reales.', longDescription: 'Consolida control de reintentos y elimina duplicación accidental de órdenes.', status: 'CONSTRUIDO', icon: 'Fingerprint' },
  { id: 67, block: 'J', name: 'Reconciliación con escalado', description: 'Respuesta automática por severidad.', longDescription: 'Del monitoreo pasivo a acción operativa escalada según impacto.', status: 'CONSTRUIDO', icon: 'RefreshCw' },
  { id: 69, block: 'J', name: 'Audit trail inmutable', description: 'Trazabilidad forense del sistema.', longDescription: 'Registro encadenado para evidenciar integridad de eventos críticos.', status: 'CONSTRUIDO', icon: 'Scroll' },
  { id: 70, block: 'J', name: 'Decision envelope', description: 'Explicabilidad operativa por decisión.', longDescription: 'Conserva contexto de entrada y salida para reproducibilidad de cada acción.', status: 'CONSTRUIDO', icon: 'FileSearch' },

  { id: 80, block: 'K-L', name: 'EMS táctico base', description: 'Núcleo de ejecución por tácticas.', longDescription: 'Marco inicial para convertir intención de orden en ejecución disciplinada.', status: 'CONSTRUIDO', icon: 'Route' },
  { id: 81, block: 'K-L', name: 'Scheduler con fencing token', description: 'Control de instancia activa única.', longDescription: 'Evita doble control operativo en escenarios de failover o reinicio.', status: 'CONSTRUIDO', icon: 'KeyRound' },
  { id: 82, block: 'K-L', name: 'Capability gating por exchange', description: 'Activa solo funciones soportadas.', longDescription: 'Reduce riesgo operativo al respetar capacidades reales del proveedor.', status: 'CONSTRUIDO', icon: 'Filter' },
  { id: 83, block: 'K-L', name: 'TWAP + TCA básico', description: 'Calidad de ejecución medible.', longDescription: 'Divide ejecuciones y compara contra benchmark para mejorar fill quality.', status: 'CONSTRUIDO', icon: 'BarChart3' },
